...
--
-- Host: localhost:8889
-- Generation Time: Mar 11, 2016 at 09:18 AM
...
ALTER TABLE `notifications`
  ...
  ADD KEY `userIdF_idx` (`userId`),
  ADD KEY `categoryIdF_idx` (`categoryId`),
  ADD KEY `auctionIdF_idx` (`auctionId`);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `categoryIdF` FOREIGN KEY (`categoryId`) REFERENCES `notification_categories` (`categoryId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `auctionIdF` FOREIGN KEY (`auctionId`) REFERENCES `auctions` (`auctionId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `userIdF` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
